...
class TestApproleRoutes(IsolatedAsyncioTestCase):
    ...
    async def test_get_role_id(
        ...
        client = AsyncClient()
        if mount_point is None:
            actual_response = await client.get_role_id(role_name=role_name)
        else:
    ...
    @RequestsMocker()
    async def test_create_role_secret_id(
        self, test_label, mount_point, role_name, requests_mocker
    ):
        expected_status_code = 200
        mock_response = {
    ...
    @RequestsMocker()
    async def test_get_role_secret_id(
    ...
    @RequestsMocker()
    async def test_list_role_secrets(
        self, test_label, mount_point, role_name, secret_id, requests_mocker
    ):
        expected_status_code = 200
        mock_response = {
        ...
        mock_url = (
            "http://127.0.0.1:8200/v1/auth/{0}/role/{1}/secret-id?list=true".format(
                "approle" if mount_point is None else mount_point,
                role_name,
            )
        )
    ...
    @RequestsMocker()
    async def test_get_role_secret_id_accessor(
    ...
    @RequestsMocker()
    async def test_delete_role_secret_id(
        self, test_label, mount_point, role_name, secret_id, requests_mocker
    ):
        expected_status_code = 204

        mock_url = (
            "http://127.0.0.1:8200/v1/auth/{0}/role/{1}/secret-id/destroy".format(
                "approle" if mount_point is None else mount_point,
                role_name,
            )
        )
    ...
    @RequestsMocker()
    async def test_delete_role_secret_id_accessor(
        self, test_label, mount_point, role_name, secret_id_accessor, requests_mocker
    ):
        expected_status_code = 204

        mock_url = (
            "http://127.0.0.1:8200/v1/auth/{0}/role/{1}/secret-id-accessor/{2}".format(
                "approle" if mount_point is None else mount_point,
                role_name,
                secret_id_accessor,
            )
    ...
    @RequestsMocker()
    async def test_create_role_custom_secret_id(
        self, test_label, mount_point, role_name, secret_id, requests_mocker
    ):
        expected_status_code = 200
        mock_response = {
