...
class TestAwsEc2Methods(IsolatedAsyncioTestCase):
    ...
    async def test_auth_ec2(self, test_label, mount_point, requests_mocker):
        ...
        if mount_point is None:
            actual_response = await client.auth_ec2(pkcs7="mock_pcks7")
        else:
    ...
    @RequestsMocker()
    async def test_create_vault_ec2_client_configuration(
        ...
        self.assertEqual(first=expected_status_code, second=actual_response.status)
        await client.close()
    ...
    @RequestsMocker()
    async def test_get_vault_ec2_client_configuration(
        self, test_label, mount_point, requests_mocker
    ):
        mock_response = {
            "data": {
    ...
    @RequestsMocker()
    async def test_delete_vault_ec2_client_configuration(
        self, test_label, mount_point, requests_mocker
    ):
        expected_status_code = 204
        mock_url = "http://127.0.0.1:8200/v1/auth/{0}/config/client".format(
    ...
    @RequestsMocker()
    async def test_create_vault_ec2_certificate_configuration(
    ...
    @RequestsMocker()
    async def test_get_vault_ec2_certificate_configuration(
        self, test_label, mount_point, cert_name, requests_mocker
    ):
        mock_response = {
            "data": {
    ...
    @RequestsMocker()
    async def test_list_vault_ec2_certificate_configurations(
        self, test_label, mount_point, requests_mocker
    ):
        ...
        expected_status_code = 200
        mock_url = (
            "http://127.0.0.1:8200/v1/auth/{0}/config/certificates?list=true".format(
                "aws-ec2" if mount_point is None else mount_point,
            )
        )
        requests_mocker.register_uri(
    ...
    @RequestsMocker()
    async def test_create_ec2_role(
        ...
        if mount_point is None:
            actual_response = await client.create_ec2_role(role=role_name)
        else:
    ...
    async def test_get_ec2_role(
        ...
        if mount_point is None:
            actual_response = await client.get_ec2_role(role=role_name)
        else:
    ...
    @RequestsMocker()
    async def test_delete_ec2_role(
        self, test_label, mount_point, role_name, requests_mocker
    ):
        expected_status_code = 204
        mock_url = "http://127.0.0.1:8200/v1/auth/{0}/role/{1}".format(
        ...
        if mount_point is None:
            actual_response = await client.delete_ec2_role(role=role_name)
        else:
    ...
    async def test_list_ec2_roles(self, test_label, mount_point, requests_mocker):
        ...
        if mount_point is None:
            ...
            actual_response = await client.list_ec2_roles(mount_point=mount_point)
    ...
    @RequestsMocker()
    async def test_create_ec2_role_tag(
        self, test_label, mount_point, role_name, requests_mocker
    ):
        mock_response = {
            "data": {
