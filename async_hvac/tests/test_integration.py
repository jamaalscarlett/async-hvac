...
class IntegrationTest(IsolatedAsyncioTestCase):
    ...
    async def test_wrap_write(self):
        ...
        result = await client.write('auth/approle/role/testrole/secret-id', wrap_ttl="10s")
    ...
    async def test_secret_backend_manipulation(self):
        ...
        secret_backend_tuning = await client.get_secret_backend_tuning('generic', mount_point='test')
    ...
    async def test_userpass_auth(self):
        ...
        await client.write('auth/userpass/users/testuser', password='testpass', policies='not_root')
    ...
    async def test_create_userpass(self):
        ...
        await client.create_userpass('testcreateuser', 'testcreateuserpass', policies='not_root')
        ...
        # Test ttl:
        client.token = self.root_token()
        await client.create_userpass('testcreateuser', 'testcreateuserpass', policies='not_root', ttl='10s')
    ...
    async def test_list_userpass(self):
        ...
        await client.create_userpass('testuserone', 'testuseronepass', policies='not_root')
        await client.create_userpass('testusertwo', 'testusertwopass', policies='not_root')
    ...
    async def test_update_userpass_policies(self):
        ...
        await client.create_userpass('updatemypolicies', 'mypassword', policies='not_root')
        await client.update_userpass_policies('updatemypolicies', policies='somethingelse')
    ...
    async def test_transit_read_write(self):
        ...
        await client.transit_create_key('foo_export', exportable=True, key_type="ed25519")
    ...
    async def test_transit_encrypt_data(self):
        ...
        await client.transit_create_key('foo')
        ciphertext_resp = (await client.transit_encrypt_data('foo', 'abbaabba'))['data']['ciphertext']
        plaintext_resp = (await client.transit_decrypt_data('foo', ciphertext_resp))['data']['plaintext']
    ...
    async def test_transit_rewrap_data(self):
        ...
        await client.transit_rotate_key('foo')
        response_wrap = (await client.transit_rewrap_data('foo', ciphertext=ciphertext_resp))['data']['ciphertext']
        plaintext_resp = (await client.transit_decrypt_data('foo', response_wrap))['data']['plaintext']
        assert plaintext_resp == 'abbaabba'
    ...
    async def test_transit_generate_data_key(self):
        ...
        response_plaintext = (await client.transit_generate_data_key('foo', key_type='plaintext'))['data']['plaintext']
        assert response_plaintext

        response_ciphertext = (await client.transit_generate_data_key('foo', key_type='wrapped'))['data']
    ...
    async def test_transit_generate_rand_bytes(self):
        ...
        response_data = (await client.transit_generate_rand_bytes(data_bytes=4))['data']['random_bytes']
    ...
    async def test_transit_hash_data(self):
        ...
        response_hash = (await client.transit_hash_data('abbaabba', algorithm="sha2-512"))['data']['sum']
    ...
    async def test_transit_generate_verify_hmac(self):
        ...
        response_hmac = (await client.transit_generate_hmac('foo', 'abbaabba'))['data']['hmac']
        assert response_hmac
        verify_resp = (await client.transit_verify_signed_data('foo', 'abbaabba', hmac=response_hmac))['data']['valid']
        assert verify_resp

        response_hmac = (await client.transit_generate_hmac('foo', 'abbaabba', algorithm='sha2-512'))['data']['hmac']
        assert response_hmac
        verify_resp = (await client.transit_verify_signed_data('foo', 'abbaabba',
    ...
    async def test_transit_sign_verify_signature_data(self):
        ...
        signed_resp = (await client.transit_sign_data('foo', 'abbaabba'))['data']['signature']
        assert signed_resp
        verify_resp = (await client.transit_verify_signed_data('foo', 'abbaabba', signature=signed_resp))['data']['valid']
        assert verify_resp

        signed_resp = (await client.transit_sign_data('foo', 'abbaabba', algorithm='sha2-512'))['data']['signature']
        assert signed_resp
        verify_resp = (await client.transit_verify_signed_data('foo', 'abbaabba',
                                                                    algorithm='sha2-512',
    ...
    async def test_tls_auth(self):
        ...
        await client.write('auth/cert/certs/test', display_name='test',
    ...
    async def test_create_token_w_role(self):
        ...
        assert (await client.create_token_role(
    ...
    async def test_start_generate_root_with_completion(self):
        ...
        new_root_token = util.decode_generated_root_token(response['encoded_root_token'], test_otp)
        """
    ...
    async def _test_kv2_secret_backend(self):
        if 'test/' in (await client.list_secret_backends()):
            await client.disable_secret_backend('test')
        await client.enable_secret_backend('kv', mount_point='test', options={'version': '2'})

        secret_backends = await client.list_secret_backends()
